...
def get_users():
    ...
    for u in users:
        ...
        is_online = u[0] in online_users
        user_list.append({'uid': u[0], 'username': u[1], 'unread': unread_count, 'online': is_online})
...
def on_join(data):
    ...
    if user_id:
        ...
        emit('user_status_change', list(online_users), broadcast=True)
