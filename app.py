...
def init_db():
    ...
    c = conn.cursor()
    # Contact ko bhi UNIQUE banaya gaya hai taaki duplicate accounts na banein
    c.execute('''CREATE TABLE IF NOT EXISTS users
                 (uid TEXT PRIMARY KEY, username TEXT UNIQUE, contact TEXT UNIQUE, password TEXT)''')
...
def signup():
    ...
    try:
        ...
        return jsonify({'status': 'error', 'message': 'यह यूजरनेम या मोबाइल नंबर पहले से रजिस्टर है!'})
