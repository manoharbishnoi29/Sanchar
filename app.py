...
def init_db():
    ...
    # Messages Table (is_read कॉलम जोड़ा गया है)
...
# सभी यूज़र्स (ऑनलाइन + ऑफलाइन) प्राप्त करने के लिए API
...
def get_users():
    ...
    # अनरीड मैसेज की गिनती साथ में भेजें
    user_list = []
    for u in users:
...
# किसी यूजर के साथ मैसेज हिस्ट्री प्राप्त करना
...
def get_messages():
    ...
    # जब चैट खुलेगी, तो प्राप्त हुए मैसेजेस को read (1) मार्क कर दें
...
def handle_private_message(data):
    ...
    # मैसेज डेटाबेस में सेव करें (ऑफलाइन यूजर भी बाद में देख सकेगा)
    conn = sqlite3.connect('sanchar.db')
    c = conn.cursor()
    ...
    # प्रेषक और प्राप्तकर्ता दोनों को रियल-टाइम रूम मैसेज भेजें
